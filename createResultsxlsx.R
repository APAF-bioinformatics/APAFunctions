#' Creates an Excel workbook all results. Later it should format based upon experiment. Doesn't currently require any arguments -- creating this workbook is self-contained
#'
...
createResultsxlsx <- function(res.list, Anova.table, design, comps){ #Currently no defaults, you must supply all. Can change to arg=arg defaults later 
  ...
  printxlsxSimpleSheet(wb, "InputParameters", params)
